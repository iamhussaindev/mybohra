...
export default function ScrollableDuas({
  items,
  navigation,
  currentSound,
  title,
  ...
  return (
    ...
    >
      {props.items.map((item) => {
        const isCurrent = item.id === props.currentSoundId
        const isCurrentPlaying = props.state === State.Playing && isCurrent
