...
interface EventReminderScreenProps extends AppStackScreenProps<"EventReminder"> {}

export const EventReminderScreen: FC<EventReminderScreenProps> = observer(
  function EventReminderScreen(props) {
